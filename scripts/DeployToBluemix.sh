...
LT_SERVICE_NAME="Language Translator Instance"
CLOUDANT_SERVICE_NAME="Cloudant for Language Translator"
OBJECT_STORAGE_SERVICE_NAME="Object Storage for Language Translator"
MONITORING_SERVICE_NAME="Monitoring for Language Translator"
APP_NAME="Watson Language Translator Tooling"
#APP_DOMAIN="ng.mybluemix.net"
APP_DOMAIN="mybluemix.net"
APP_HOST_NAME="lt-ui-jm"
